...
if ($addnew=="1" )
{
	...
	$sql="update yuangongxinxi set gonghao='$gonghao',xingming='$xingming',nianling='$nianling',shenfenzheng='$shenfenzheng',dianhua='$dianhua',youxiang='$youxiang',zhaopian='$zhaopian',zhuyaozhize='$zhuyaozhize',ruzhishijian='$ruzhishijian',xingbie='$xingbie',beizhu='$beizhu' where gonghao= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<?php
$sql="select * from yuangongxinxi where gonghao='".$_SESSION["username"]."'";
