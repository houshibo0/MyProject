...
if ($addnew=="1" )
{
	...
	$sql="update rukujilu set bianhao='$bianhao',mingcheng='$mingcheng',leibie='$leibie',rukushuliang='$rukushuliang',rukujiage='$rukujiage',laizichangshang='$laizichangshang',beizhu='$beizhu',caozuoyuan='$caozuoyuan' where id= ".$id;
	mysql_query($sql);
	echo "<script>javascript:alert('修改成功!');location.href='rukujilu_list.php';</script>";
}
?>
...
<title>修改入库记录</title><link rel="stylesheet" href="css.css" type="text/css"><script language="javascript" src="js/Calendar.js"></script>
</head>
