...
<form id="form1" name="form1" method="post" action="">
  搜索: 编号：<input name="bianhao" type="text" id="bianhao" /> 名称：<input name="mingcheng" type="text" id="mingcheng" /> 类别：<input name="leibie" type="text" id="leibie" /> 类型：<select name='leixing' id='leixing'></select> 操作员：<input name="caozuoyuan" type="text" id="caozuoyuan" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from chukujilu where caozuoyuan='".$_SESSION['username']."'";
...
<p align="center"><a href="chukujilu_list2.php?pagecurrent=1">首页</a>, <a href="chukujilu_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="chukujilu_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="chukujilu_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
